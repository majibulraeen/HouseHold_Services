	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="<?php echo base_url()?>tools/img/slides/1.jpg" alt="flexslider" /> 
              ...
              <li>
                <img src="<?php echo base_url()?>tools/img/slides/2.jpg" alt="flexslider" /> 
                <div class="flex-caption">
	...
	<div class="container">
		...
		<div class="box"> 
		<span class="icons c1"><i class="fa fa-cog"></i></span> <div class="box-area">
		...
		<div class="col-md-3 text-center"> 
		<div class="box"> 
		<span class="icons c2"><i class="fa fa-sign-in"></i></span> <div class="box-area">
		...
		<div class="col-md-3 text-center"> 
		<div class="box">
		<span class="icons c4"><i class="fa fa-home"></i></span> <div class="box-area">
	...
	<div class="container">
		<div class="row">
		<div class="col-md-6"><img src="<?php echo base_url()?>tools/img/img1.png" class="img-center" alt="" /></div>
			<div class="col-md-6">
				<div><h2>Our Team</h2>
