			...
			<div class="col-lg-12">
				...
				<div class="row">
					...
					<ul id="thumbs" class="portfolio">
						...
						<img src="<?php echo base_url()?>tools/img/works/1.jpg" alt="">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						...
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url()?>tools/img/works/2.jpg" alt="">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						...
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url()?>tools/img/works/3.jpg" alt="">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						<li class="item-thumbs design" data-id="id-0" data-type="web">
						...
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url()?>tools/img/works/4.jpg" alt="">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						...
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url()?>tools/img/works/5.jpg" alt="">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						...
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url()?>tools/img/works/6.jpg" alt="">
						</li>
						<!-- End Item Project -->
						<li class="item-thumbs design" data-id="id-0" data-type="web">
						<!-- Fancybox - Gallery Enabled - Title - Full Image -->
						...
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url()?>tools/img/works/7.jpg" alt="">
						</li>
						<!-- End Item Project -->
						<!-- Item Project and Filter Name -->
						...
						<!-- Thumb Image and Description -->
						<img src="<?php echo base_url()?>tools/img/works/8.jpg" alt="">
						</li>
						<!-- End Item Project -->
					</ul>
					</section>
